	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">sirena</a>
			</div>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#">Link</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">mas <b class="caret">
...
<video autobuffer autoloop loop controls width="800">
	<source src="public/videos/1.mp4">
	
</video>
<audio autobuffer autoloop loop controls>
	<source src="public/musica/Por Fin Te Encontré - Adexe & Nau (Cali & El Dandee ft Juan Magan, Sebastian Yatra cover).mp3">
